    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (source != null) {
            ...
            /*try {
                ...
                FileUtil.storeBitmap(AppConfig.PATH_ROOT + File.separator + "test" + File.separator + System.currentTimeMillis() + ".jpg", bitmap1);
            } catch (Exception e) {
                e.printStackTrace();
            }*/
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, Config.decode_succeeded, rawResult);
