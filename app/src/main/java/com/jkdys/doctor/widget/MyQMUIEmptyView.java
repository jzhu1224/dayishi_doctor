 ...
 * </p>
 */
public class MyQMUIEmptyView extends FrameLayout {
    ...
    public MyQMUIEmptyView(Context context) {
        this(context,null);
    }

    public MyQMUIEmptyView(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

	public MyQMUIEmptyView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.my_qmui_empty_view, this, true);
    ...
    public void setImageEmpty(@DrawableRes int resId) {
