    ...
    protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        switch (message.getType()) {
            case TXT:
                ...
                break;
            case LOCATION:
                chatRow = new MyEaseChatRowLocation(context, message, position, this);
                break;
            case FILE:
                chatRow = new EaseChatRowFile(context, message, position, this);
                break;
            case IMAGE:
                chatRow = new MyEaseChatRowImage(context, message, position, this);
                break;
            case VOICE:
                chatRow = new MyEaseChatRowVoice(context, message, position, this);
                break;
            case VIDEO:
