...
public class DepartmentAdapter extends RightMenuBaseListAdapter<ViewHolder,DepartmentData> {

    public DepartmentAdapter(Context ctx, List<DepartmentData> list) {
        super(ctx, list);
    }
