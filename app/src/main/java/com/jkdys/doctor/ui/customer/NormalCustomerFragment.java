...
public class NormalCustomerFragment extends BaseRefreshLoadMoreFrament<PatientInfo,BaseLoadMoreView<PatientInfo>,CustomerPresenter> {
    ...
    protected void afterCreatePresenter() {
        ...
        customerPresenter.setGrouptype(2);
    }
