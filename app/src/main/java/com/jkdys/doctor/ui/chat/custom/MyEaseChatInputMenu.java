...
public class MyEaseChatInputMenu extends EaseChatInputMenu {
    ...
    public MyEaseChatInputMenu(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public MyEaseChatInputMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MyEaseChatInputMenu(Context context) {
        super(context);
        init(context, null);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // extend menu
        chatExtendMenu = (MyEaseChatExtendMenu) findViewById(R.id.extend_menu);
    }
    ...
    public MyEaseChatExtendMenu getExtendMenu(){
    ...
    public void registerExtendMenuItem(String name, int drawableRes, int itemId,
                                       MyEaseChatExtendMenu.EaseChatExtendMenuItemClickListener listener) {
    ...
    public void setChatInputMenuListener(EaseChatInputMenu.ChatInputMenuListener listener) {
