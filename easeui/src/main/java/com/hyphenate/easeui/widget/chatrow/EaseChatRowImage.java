        ...
        if (bitmap != null) {
            ...
            new AsyncTask<Object, Void, Bitmap>() {
                ...
                protected Bitmap doInBackground(Object... args) {
                    int wh = getResources().getDimensionPixelOffset(R.dimen.img_wh);
                    File file = new File(thumbernailPath);
                    if (file.exists()) {
                        return EaseImageUtils.getScaleImage(thumbernailPath, wh, wh);
                    } else if (new File(imgBody.thumbnailLocalPath()).exists()) {
                        return EaseImageUtils.getScaleImage(imgBody.thumbnailLocalPath(), wh, wh);
                    } else {
                        if (message.direct() == EMMessage.Direct.SEND) {
                            if (localFullSizePath != null && new File(localFullSizePath).exists()) {
                                return EaseImageUtils.getScaleImage(localFullSizePath, wh, wh);
                            } else {
                                return null;
                            }
                        } else {
